...
(function (f) {
    ...
    var x = window.MutationObserver || window.WebKitMutationObserver || !1, K = {
        ...
        function t(b, g, c) {
            var d, e;
            0 == b.deltaMode ? (d = -Math.floor(a.opt.mousescrollstep / 54 * b.deltaX), e = -Math.floor(a.opt.mousescrollstep / 54 * b.deltaY)): 1
        ==
            b.deltaMode && (d = -Math.floor(b.deltaX * a.opt.mousescrollstep), e = -Math.floor(b.deltaY * a.opt.mousescrollstep));
        ...
        this.doSnapy = function (f,
            ...
            0 > h ? (h = 0, d = !0): h
            >
            c.nc.page.maxh && (h = c.nc.page.maxh, d = !0);
            0 > f ? (f = 0, d = !0): f
            >
            c.nc.page.maxw && (f = c.nc.page.maxw, d = !0);
